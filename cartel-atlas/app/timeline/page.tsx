  ...
  return (
    <div style={{ background:'#0a0a16', minHeight:'100vh', color:'#fff', fontFamily:'system-ui, sans-serif' }}>
      ...
      <div style={{ background:'#0f0f1f', borderBottom:'1px solid #222', padding:'10px 20px', display:'flex', gap:10, flexWrap:'wrap', alignItems:'center' }}>
        ...
        <select value={filterCartel} onChange={e=>setFilterCartel(e.target.value)}
            ...
            <div style={{ padding:20 }}>
              ...
              {selectedEvent.personIds&&selectedEvent.personIds.length>0&&(
                <div style={{ marginBottom:16 }}>
                  ...
                  {selectedEvent.personIds.map(pid=>{
                    const p = PEOPLE.find(x=>x.id===pid);
              ...
              <div style={{ marginBottom:16 }}>
                ...
                {selectedEvent.cartelIds.map(cid=>{
                  const c = CARTELS.find(x=>x.id===cid);
